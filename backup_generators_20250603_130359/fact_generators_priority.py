...
def generate_f_oferta_admision(n=500, dimension_dfs=None):
    ...
    for i in tqdm(range(1, n+1), desc="Generando ofertas de admisión"):
        ...
        ,
            'FLG_ADMITIDOS_TODOS_1': None  # AGREGADO: Columna requerida por esquema,
            'FLG_ADMITIDOS_TODOS_2': None  # AGREGADO: Columna requerida por esquema,
            'NOTA_CORTE_ADJUDICACION_1': None  # AGREGADO: Columna requerida por esquema,
            'NOTA_CORTE_ADJUDICACION_2': None  # AGREGADO: Columna requerida por esquema,
            'NOTA_CORTE_DEFINITIVA_1': None  # AGREGADO: Columna requerida por esquema,
            'NOTA_CORTE_DEFINITIVA_2': None  # AGREGADO: Columna requerida por esquema,
            'PARTICIPA_1': None  # AGREGADO: Columna requerida por esquema,
            'PARTICIPA_2': None  # AGREGADO: Columna requerida por esquema,
            'PLAZAS_SOLICITADAS_PREF_1': None  # AGREGADO: Columna requerida por esquema,
            'PRELA_CONVO_NOTA_DEF_1': None  # AGREGADO: Columna requerida por esquema,
            'PRELA_CONVO_NOTA_DEF_2': None  # AGREGADO: Columna requerida por esquema})
